        ...
        <footer className="bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl">
                ...
                <div className="px-4 py-6  bg-gray-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-300 sm:text-center">© 2023 <a href="#">Volumize</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                        <a href="https://www.instagram.com/volumize_ai/" className="text-gray-400 hover:text-white">    
